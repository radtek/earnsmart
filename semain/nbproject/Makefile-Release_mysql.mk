...
LDLIBSOPTIONS=-Wl,-rpath,'../seadmin/dist/Release_mysql/GNU-Linux' -L../seadmin/dist/Release_mysql/GNU-Linux -lseadmin -Wl,-rpath,'../sesecurities/dist/Release_mysql/GNU-Linux' -L../sesecurities/dist/Release_mysql/GNU-Linux -lsesecurities -Wl,-rpath,'../sexbrl/dist/Release_mysql/GNU-Linux' -L../sexbrl/dist/Release_mysql/GNU-Linux -lsexbrl -Wl,-rpath,'../sedata/dist/Release/GNU-Linux' -L../sedata/dist/Release/GNU-Linux -lsedata -Wl,-rpath,'../semysql/dist/Release_mysql/GNU-Linux' -L../semysql/dist/Release_mysql/GNU-Linux -lsemysql -Wl,-rpath,'../seglobal/dist/Release/GNU-Linux' -L../seglobal/dist/Release/GNU-Linux -lseglobal -lrt -lboost_system -lboost_filesystem -lboost_locale -luuid

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsemain.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsemain.${CND_DLIB_EXT}: ../seadmin/dist/Release_mysql/GNU-Linux/libseadmin.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsemain.${CND_DLIB_EXT}: ../sesecurities/dist/Release_mysql/GNU-Linux/libsesecurities.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsemain.${CND_DLIB_EXT}: ../sexbrl/dist/Release_mysql/GNU-Linux/libsexbrl.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsemain.${CND_DLIB_EXT}: ../sedata/dist/Release/GNU-Linux/libsedata.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsemain.${CND_DLIB_EXT}: ../semysql/dist/Release_mysql/GNU-Linux/libsemysql.so
...
${OBJECTDIR}/CApplication.o: CApplication.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CApplication.o CApplication.cpp

${OBJECTDIR}/CConfigItem.o: CConfigItem.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CConfigItem.o CConfigItem.cpp

${OBJECTDIR}/CConfigurator.o: CConfigurator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CConfigurator.o CConfigurator.cpp

${OBJECTDIR}/CMain.o: CMain.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CMain.o CMain.cpp

${OBJECTDIR}/CNamedObjectList.o: CNamedObjectList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNamedObjectList.o CNamedObjectList.cpp

${OBJECTDIR}/CSession.o: CSession.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSession.o CSession.cpp

${OBJECTDIR}/CSessionActivity.o: CSessionActivity.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSessionActivity.o CSessionActivity.cpp
