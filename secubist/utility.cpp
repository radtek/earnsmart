...
/*************************************************************************/
/*									 */
/*	Print header for Cubist programs				 */
/*	--------------------------------				 */
/*									 */
/*************************************************************************/
...
namespace se
{
    namespace math
    {
        ...
        void CCubist::PrintHeader(__String Title)
        /*   -----------  */
        {
            char	TitleLine[80];
            time_t	clock;
        ...
        __String	OptArg, Option;


        char CCubist::ProcessOption(int Argc, char *Argv[], char *Options)
        /*   -------------  */
        {
            int		i;
            static int	OptNo=1;
            ...
            {
                OptArg = (__String) ( Options[i+1] != '+' ? Nil :
                       Option[2] ? Option+2 :
        ...
        void * CCubist::Pmalloc(size_t Bytes)
        /*    -------  */
        {
            void *p=Nil;
        ...
        void * CCubist::Prealloc(void *Present, size_t Bytes)
        /*    --------  */
        {
            void *p=Nil;
        ...
        void * CCubist::Pcalloc(size_t Number, unsigned int Size)
        /*    -------  */
        {
            void *p=Nil;
        ...
        void CCubist::FreeVector(void **V, int First, int Last)
        /*   ----------  */
        {
            if ( V )
            {
        ...
        void CCubist::FreeLastCase(DataRec Case)
        /*   ------------  */
        {
            if(DataMem)
                DataMem->Allocated--;
        ...
        void CCubist::ResetKR(int KRInit)
        /*   -------  */
        {
            KRFp = KRSp = 0;
        ...
        void CCubist::Error(int ErrNo, __String S1, __String S2)
        /*   -----  */
        {
            ...
            /* we can't quit while running the webserver.
            if ( Quit && Of )
            {
                Goodbye(1);
            }
        ...
        __String CCubist::CaseLabel(CaseNo N)
        /*     ---------  */
        {
            __String      p;
        ...
        FILE * CCubist::GetFile(__String Extension, __String RW)
        /*    --------  */
        {
            strcpy(Fn, FileStem);
            strcat(Fn, Extension);
        ...
        /*************************************************************************/
        /*									 */
        /*	Determine precision of floating value (max 6 digits)		 */
        /*									 */
        /*************************************************************************/


        int CCubist::Denominator(ContValue Val)
        /*  -----------  */
        {
        ...
        int CCubist::FracBase(Attribute Att)
        /*  --------  */
        {
            CaseNo	i;
        ...
        int CCubist::GetInt(__String S, int N)
        /*  ------  */
        {
            int	Result=0;
        ...
        int CCubist::DateToDay(__String DS)	/*  Day 1 is 0000/03/01  */
        /*  ---------  */
        {
            int Year, Month, Day;
        ...
        void CCubist::DayToDate(int Day, __String Date)
        /*   ---------  */
        {
        ...
        int CCubist::TimeToSecs(__String TS)
        /*  ----------  */
        {
            int Hour, Mins, Secs;
        ...
        void CCubist::SecsToTime(int Secs, __String Time)
        /*   ----------  */
        {
            int Hour, Mins;
        ...
        int CCubist::TStampToMins(__String TS)
        /*  ------------  */
        {
            int		Day, Sec, i;
        ...
        /*************************************************************************/
        /*									 */
        /*	Convert a continuous value to a string.	 DS must be large	 */
        /*	enough to hold any value (e.g. a date, time, ...)		 */
        /*									 */
        /*************************************************************************/


        void CCubist::CValToStr(ContValue CV, Attribute Att, __String DS)
        /*   ---------  */
        {
            int	Mins;
        ...
        void CCubist::Check(float Val, float Low, float High)
        /*   -----  */
        {
            if ( Val < Low || Val > High )
            {
        ...
        /*   -------  */
        {
            ...
            /*  Release intermediate tree/rules if interrupted  */
