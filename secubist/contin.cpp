...
namespace se
{
    namespace math
    {
        ...
        void CCubist::EvalContinuousAtt(Tree Node, Attribute Att, CaseNo Fp, CaseNo Lp)
        /*   -----------------  */ 
        { 
        ...
        void CCubist::ContinTest(Tree Node, Attribute Att, float Cut)
        /*   ----------  */
        {
            Sprout(Node, 3);
        ...
        void CCubist::AdjustAllThresholds(Tree T)
        /*   -------------------  */
        {
            Attribute	Att;
        ...
        void CCubist::AdjustThresholds(Tree T, Attribute Att)
        /*   ----------------  */
        {
            DiscrValue	v;
            CaseNo	i;
        ...
        ContValue CCubist::GreatestValueBelow(ContValue Th)
        /*	  ------------------  */
        {
            CaseNo	Low, High, Mid;
