...
namespace se
{
    namespace math
    {
        ...
        RRuleSet CCubist::FormRules(Tree T)
        /*	 ---------  */
        {
            CaseNo	i;
            RRuleSet	RS;
        ...
        void CCubist::TreeParameters(Tree T, int D)
        /*   --------------  */
        {
            DiscrValue	v;
        ...
        void CCubist::PruneRule(Condition Cond[], float InitCoeffs)
        /*   ---------  */
        {
        ...
        void CCubist::UpdateCount(int d, CaseNo i, double *Total, double *PredErr)
        /*   -----------  */
        {
        ...
        void CCubist::AddToList(CaseNo *List, CaseNo N)
        /*   ---------  */
        {
            Succ[N] = *List;
            *List   = N;
        ...
        void CCubist::DeleteFromList(CaseNo *Before, CaseNo N)
        /*   --------------  */
        {
            *Before = Succ[N];
        }
        ...
        int CCubist::SingleFail(CaseNo i)
        /*  ----------  */
        {
            int		d;
        ...
        void CCubist::RemoveBias(CRule R, int Coeffs)
        /*   ----------  */
        {
        ...
        void CCubist::FreeFormRuleData(void)
        /*   ----------------  */
        {
