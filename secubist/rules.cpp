...
namespace se
{
    namespace math
    {
        ...
        Boolean CCubist::NewRule(Condition Cond[], int NCond, Boolean *Deleted,
                CaseCount Cover, float Mean, float LoVal, float HiVal,
        ...
        /*      -------  */
        {
            ...
            //extern double *Total; // commented out because it is now a class member.
        ...
        Boolean CCubist::SameRule(RuleNo r, Condition Cond[], int NConds)
        /*      --------  */
        {
            int	d, i, Bytes;
        ...
        void CCubist::ReleaseRule(CRule R)
        /*   -----------  */
        {
            int	d;
        ...
        void CCubist::FreeCttee(RRuleSet *Cttee)
        /*   ---------  */
        {
            if (!Cttee)
                return;
        ...
        void CCubist::PrintRules(RRuleSet RS, __String Msg)
        /*   ----------  */
        {
            int	r;
        ...
        void CCubist::PrintRule(CRule R)
        /*   ---------  */
        {
        ...
        void CCubist::PrintCondition(Condition C)
        /*  --------------  */
        {
        ...
        Boolean CCubist::Satisfies(DataRec CaseDesc, Condition OneCond)
        /*      ---------  */
        {
            DiscrValue	v;
            ContValue	cv;
