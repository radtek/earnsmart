...
namespace se
{
    namespace math
    {
        ...
        void CCubist::SetProperties(Tree T, Tree Parent)
        /*   -------------  */
        {
            DiscrValue	v;
        ...
        void CCubist::UnsproutAndUpdate(Tree Pruned, double ExtraErr, double ExtraParams)
        /*   -----------------  */
        {
            DiscrValue	v;
            Tree	T;
        ...
        void CCubist::SmoothModels(Tree T, Tree Parent, CaseNo Fp, CaseNo Lp)
        /*   ------------  */
        {
            DiscrValue	v;
            Attribute	Att;
        ...
        double CCubist::ErrVariance(double *Model, CaseNo Fp, CaseNo Lp, double *Err)
        /*     -----------  */
        {
        ...
        void CCubist::FindErrors(Tree T, CaseNo Fp, CaseNo Lp)
        /*   ----------  */
        {
            CaseNo	i, Bp, Cases;
        ...
        Boolean CCubist::FindWeakestSubtree(Tree T)
        /*      ------------------  */
        {
            Boolean	Found=false;
        ...
        float CCubist::TreeValue(Tree T, DataRec Case)
        /*    ---------  */
        { 
            DiscrValue	v, f;
            double	Val;
        ...
        float CCubist::MedianResid(CaseNo Fp, CaseNo Lp, double Want)
        /*    -----------  */
        {
            ...
            return GEnv.Resid ? GEnv.Resid[Fp] : 0;
        }
