...
#define	 T_OptMaxRules		"\tMaximum of %ld rules\n"
...
#define	 TX_NNeighbors(n)	"\tUse %ld nearest neighbor%s\n", n, Plural(n)
#define	 T_NoBias		"\tUnbiased rules\n"
#define	 T_OptSampling		"\tUse %g%% of data for training\n"
#define	 T_OptSeed		"\tRandom seed %ld\n"
#define	 T_OptXval		"\t%ld-fold cross-validation\n"
#define	 T_OptCttee		"\t%ld-member committee model\n"
...
#define	 T_TargetAtt		"\n    Target attribute `%s'\n"
#define	 TX_ReadData(c,a,f)	"\nRead %ld cases (%ld attributes) from"\
					" %s.data\n", c, a, f
#define	 TX_ReadTest(c,f)	"Read %ld cases from %s.test\n", c, f
#define	 T_CWtAtt		"Using relative case weighting\n"
#define	 T_AttributesIn		"\nAttributes included:\n"
#define	 T_AttributesOut	"\nAttributes excluded:\n"
#define	 T_EvalTrain		"\n\nEvaluation on training data (%ld cases%s):\n"
#define	 T_AttUsage		"\n\n\tAttribute usage:\n"\
				"\t  Conds  Model\n\n"
#define	 T_EvalTest		"\nEvaluation on test data (%ld cases):\n"
#define	 T_Time			"\n\nTime: %.1f secs\n"
...
#define	 T_Fold			"Fold"
#define	 T_EvalHoldOut		"\nEvaluation on hold-out data (%ld cases):\n"
#define	 T_MeanErrMag		"Mean |error|"

#define	 TX_Line(l,f)		"*** line %ld of `%s':\n    ", l, f
