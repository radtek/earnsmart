...
#define	 Select(t)		(UseAll? (t) :\
					 (MaxInstance+1)*((2*(t)+1)/(2.0*Try)))
...
namespace se
{
    namespace math
    {
        ...
        Boolean CCubist::InitialiseInstances(RRuleSet *Cttee)
        /*   -------------------  */
        {
            ...
            ForEach(i, 0, MaxCase)
            {
                RSPredVal[i] = PredictValue(Cttee, Instance[i]);
            }
        ...
        #define MAXLOOPALLOWED      100000

        Boolean CCubist::SetParameters(RRuleSet *Cttee)
        /*   -------------  */
        {
        ...
        void CCubist::CheckForms(RRuleSet *Cttee)
        /*   ----------  */
        {
            CaseNo	i;
            int		t;
            ...
            ForEach(i, 0, MEMBERS-1)
            {
            AvRules += Cttee[i]->SNRules;
            }
            AvRules /= MEMBERS;
        ...
        */
        ...
        void CCubist::CopyInstances(void)
        /*   -------------  */
        {
            AttValue	*KDBlockP;
            CaseNo	i;
        ...
        float CCubist::NNEstimate(RRuleSet *Cttee, DataRec Case)
        /*    ----------  */
        {
        ...
        float CCubist::Distance(DataRec Case1, DataRec Case2, float Thresh)
        /*    --------  */
        {
            Attribute	Att;
            double	DTot, Diff;
        ...
        void CCubist::CheckDistance(DataRec Case, CaseNo Saved)
        /*   -------------  */
        {
            int		d, dd;
            float	Dist;
            ...
            Dist = rint(DPREC *
                Distance(Case, Instance[Saved], *GNNEnv.WorstBest + 0.55 / DPREC))
               / DPREC;
        ...
        void CCubist::FindNearestNeighbors(DataRec Case)
        /*   --------------------  */
        {
            int		d;
            Attribute	Att;
        ...
        float CCubist::AverageNeighbors(RRuleSet *Cttee, DataRec Case)
        /*    ----------------  */
        {
        ...
        Index CCubist::BuildIndex(CaseNo Fp, CaseNo Lp)
        /*    ----------  */
        {
            Index	Node;
            DiscrValue	v, vv;
        ...
        void CCubist::SwapInstance(CaseNo A, CaseNo B)
        /*   ------------  */
        {
            DataRec	Hold;
        ...
        void CCubist::ScanIndex(DataRec Case, Index Node, float MinD)
        /*   ---------  */
        {
            CaseNo	Xp;
        ...
        void CCubist::FreeIndex(Index Node)
        /*   ---------  */
        {
            DiscrValue	v, Forks;
            Attribute	Att;
        ...
        void CCubist::FreeInstances(void)
        /*   -------------  */
        {
            try
            {
