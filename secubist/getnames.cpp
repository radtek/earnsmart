...
namespace se
{
    namespace math
    {
        ...
        Boolean CCubist::ReadName(FILE *f, __String s, int n, char ColonOpt)
        /*      --------  */
        {
            register char *Sp=s;
            register int  c;
        ...
        void CCubist::ExplicitAtt(FILE *Nf)
        /*   -----------  */
        {
            char	Buffer[1000]="", *p;
            DiscrValue	v;
            ...
            if ( ! memcmp(Buffer, "discrete", 8) )
            {
                ...
                AttValName[MaxAtt] = Alloc(v+3, __String);
        ...
        int CCubist::Which(__String Val, __String *List, int First, int Last)
        /*  -----  */
        {
            int	n=First;
        ...
        void CCubist::ListAttsUsed(void)
        /*   ------------  */
        {
            Attribute	Att;
            Boolean	*DefUses;
        ...
        void CCubist::FreeNamesData(void)
        /*   -------------  */
        {
            Attribute a, t;
            ...
            FreeUnlessNil(AttUnit);				AttUnit = Nil;
            FreeUnlessNil(AttPref);				AttPref = Nil;
        }
