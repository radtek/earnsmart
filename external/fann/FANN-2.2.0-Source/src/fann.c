...
FANN_EXTERNAL struct fann *FANN_API fann_create_basic(unsigned int num_layers, unsigned int num_input, unsigned int num_hidden, unsigned int num_outputs)
{
	unsigned int layers[4] = { num_input, num_hidden, num_hidden, num_outputs };
