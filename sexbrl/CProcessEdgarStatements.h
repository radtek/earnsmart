...
[[deprecated("sec changed its download format. New class is CProcessEdgarStatementsJson")]]
...
private:
    ...
    UID _lastRecId;
    string _sqlRecord;
    const string _deleteInstcontext;
    const string _deleteInst;
    const string _deleteCalc;
    const string _deletePre;
    const string _deleteStmt;
    bool _bFixConcurrency;
};
