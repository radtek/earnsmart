...
OUTPUT_PATH=${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/seunittest
OUTPUT_BASENAME=seunittest
PACKAGE_TOP_DIR=seunittest/
...
cd "${TOP}"
makeDirectory "${NBTMPDIR}/seunittest/bin"
...
cd "${TOP}"
makeDirectory "${NBTMPDIR}/seunittest/bin"
copyFileToTmpDir "${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsepredict.so" "${NBTMPDIR}/${PACKAGE_TOP_DIR}bin/libsepredict.so" 0755
...
# Generate tar file
cd "${TOP}"
rm -f ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/seunittest.tar
cd ${NBTMPDIR}
tar -vcf ../../../../${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/seunittest.tar *
checkReturnCode
