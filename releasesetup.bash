...
cp -f "${PWD}/external/mariadbpp/${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libmariadbpp.so" "${TOP}/${CND_CONF}/"
...
copyBinary "seeoddata" "libseeoddata.so"
