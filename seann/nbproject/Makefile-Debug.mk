...
LDLIBSOPTIONS=-Wl,-rpath,'../seglobal/dist/Debug/GNU-Linux' -L../seglobal/dist/Debug/GNU-Linux -lseglobal -lm

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libseann.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libseann.${CND_DLIB_EXT}: ../seglobal/dist/Debug/GNU-Linux/libseglobal.so
...
${OBJECTDIR}/CFann.o: CFann.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__DEBUG__ -I/usr/include/mariadb -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CFann.o CFann.cpp

${OBJECTDIR}/doublefann.o: doublefann.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -D__DEBUG__ -std=c11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/doublefann.o doublefann.c

${OBJECTDIR}/fann.o: fann.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -D__DEBUG__ -std=c11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fann.o fann.c

${OBJECTDIR}/fann_cascade.o: fann_cascade.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -D__DEBUG__ -std=c11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fann_cascade.o fann_cascade.c

${OBJECTDIR}/fann_error.o: fann_error.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -D__DEBUG__ -std=c11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fann_error.o fann_error.c

${OBJECTDIR}/fann_io.o: fann_io.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -D__DEBUG__ -std=c11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fann_io.o fann_io.c

${OBJECTDIR}/fann_train.o: fann_train.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -D__DEBUG__ -std=c11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fann_train.o fann_train.c

${OBJECTDIR}/fann_train_data.o: fann_train_data.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -D__DEBUG__ -std=c11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fann_train_data.o fann_train_data.c
