...
${OBJECTDIR}/Earnsmart.o: Earnsmart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Earnsmart.o Earnsmart.cpp

${OBJECTDIR}/SEApplication.o: SEApplication.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SEApplication.o SEApplication.cpp
