...
${OBJECTDIR}/CPredictionSetup.o: CPredictionSetup.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -I/usr/include/libxml2 -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPredictionSetup.o CPredictionSetup.cpp

${OBJECTDIR}/CTrainingAPI.o: CTrainingAPI.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -I/usr/include/libxml2 -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CTrainingAPI.o CTrainingAPI.cpp

${OBJECTDIR}/IndicatorTrainingClasses.o: IndicatorTrainingClasses.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -I/usr/include/libxml2 -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndicatorTrainingClasses.o IndicatorTrainingClasses.cpp
