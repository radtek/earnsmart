...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/seweb: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/seweb ${OBJECTFILES} ${LDLIBSOPTIONS} -rdynamic

${OBJECTDIR}/CAppBase.o: CAppBase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CAppBase.o CAppBase.cpp

${OBJECTDIR}/CAppMain.o: CAppMain.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CAppMain.o CAppMain.cpp

${OBJECTDIR}/CBrowserSession.o: CBrowserSession.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CBrowserSession.o CBrowserSession.cpp

${OBJECTDIR}/CInvestmentProducts.o: CInvestmentProducts.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CInvestmentProducts.o CInvestmentProducts.cpp

${OBJECTDIR}/CJsonRPCApp.o: CJsonRPCApp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CJsonRPCApp.o CJsonRPCApp.cpp

${OBJECTDIR}/CSPSerializable.o: CSPSerializable.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSPSerializable.o CSPSerializable.cpp

${OBJECTDIR}/emailtmpls.o: emailtmpls.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/emailtmpls.o emailtmpls.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/skdefault.o: skdefault.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/skdefault.o skdefault.cpp
