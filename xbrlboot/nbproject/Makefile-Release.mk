...
${OBJECTDIR}/CXbrlCalculation.o: CXbrlCalculation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CXbrlCalculation.o CXbrlCalculation.cpp

${OBJECTDIR}/CXbrlDoc.o: CXbrlDoc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CXbrlDoc.o CXbrlDoc.cpp

${OBJECTDIR}/CXbrlElement.o: CXbrlElement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CXbrlElement.o CXbrlElement.cpp

${OBJECTDIR}/CXbrlLine.o: CXbrlLine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CXbrlLine.o CXbrlLine.cpp

${OBJECTDIR}/CXbrlStatementModel.o: CXbrlStatementModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CXbrlStatementModel.o CXbrlStatementModel.cpp

${OBJECTDIR}/CXbrlStatementParser.o: CXbrlStatementParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CXbrlStatementParser.o CXbrlStatementParser.cpp

${OBJECTDIR}/CXbrlStatementPersistor.o: CXbrlStatementPersistor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CXbrlStatementPersistor.o CXbrlStatementPersistor.cpp

${OBJECTDIR}/c_algorithms.o: c_algorithms.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_algorithms.o c_algorithms.c

${OBJECTDIR}/c_array.o: c_array.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_array.o c_array.c

${OBJECTDIR}/c_deque.o: c_deque.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_deque.o c_deque.c

${OBJECTDIR}/c_map.o: c_map.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_map.o c_map.c

${OBJECTDIR}/c_rb.o: c_rb.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_rb.o c_rb.c

${OBJECTDIR}/c_set.o: c_set.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_set.o c_set.c

${OBJECTDIR}/c_slist.o: c_slist.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_slist.o c_slist.c

${OBJECTDIR}/c_util.o: c_util.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/c_util.o c_util.c
...
${OBJECTDIR}/xbrlcalparsingtest.o: xbrlcalparsingtest.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/xbrlcalparsingtest.o xbrlcalparsingtest.c
