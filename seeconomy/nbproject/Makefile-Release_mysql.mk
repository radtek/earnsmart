...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libseeconomy.${CND_DLIB_EXT}: ../setraining/dist/Release_mysql/GNU-Linux/libsetraining.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libseeconomy.${CND_DLIB_EXT}: ../senet/dist/Release_mysql/GNU-Linux/libsenet.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libseeconomy.${CND_DLIB_EXT}: ../semysql/dist/Release_mysql/GNU-Linux/libsemysql.so
...
${OBJECTDIR}/CAbstractFeeder.o: CAbstractFeeder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CAbstractFeeder.o CAbstractFeeder.cpp

${OBJECTDIR}/CEconomicIndicator.o: CEconomicIndicator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CEconomicIndicator.o CEconomicIndicator.cpp

${OBJECTDIR}/CEconomicIndicatorFeeder.o: CEconomicIndicatorFeeder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CEconomicIndicatorFeeder.o CEconomicIndicatorFeeder.cpp

${OBJECTDIR}/CEconomicNewsFeeds.o: CEconomicNewsFeeds.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CEconomicNewsFeeds.o CEconomicNewsFeeds.cpp

${OBJECTDIR}/CEconomicNewsStorageProvider.o: CEconomicNewsStorageProvider.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CEconomicNewsStorageProvider.o CEconomicNewsStorageProvider.cpp

${OBJECTDIR}/CEconomyAPI.o: CEconomyAPI.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CEconomyAPI.o CEconomyAPI.cpp

${OBJECTDIR}/CFredDataSource.o: CFredDataSource.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CFredDataSource.o CFredDataSource.cpp

${OBJECTDIR}/CFredFeeder.o: CFredFeeder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CFredFeeder.o CFredFeeder.cpp

${OBJECTDIR}/CIndicatorCategory.o: CIndicatorCategory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CIndicatorCategory.o CIndicatorCategory.cpp

${OBJECTDIR}/CNcdcFeeder.o: CNcdcFeeder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNcdcFeeder.o CNcdcFeeder.cpp

${OBJECTDIR}/seeconomyapi.o: seeconomyapi.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mysql -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/seeconomyapi.o seeconomyapi.cpp
