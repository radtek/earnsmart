...
${OBJECTDIR}/CMysqlTable.o: CMysqlTable.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CMysqlTable.o CMysqlTable.cpp

${OBJECTDIR}/CMysqlUtilities.o: CMysqlUtilities.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CMysqlUtilities.o CMysqlUtilities.cpp

${OBJECTDIR}/CSEConnPool.o: CSEConnPool.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSEConnPool.o CSEConnPool.cpp

${OBJECTDIR}/CSEConnections.o: CSEConnections.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSEConnections.o CSEConnections.cpp

${OBJECTDIR}/CStoreQueryResult.o: CStoreQueryResult.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/mariadb -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CStoreQueryResult.o CStoreQueryResult.cpp
